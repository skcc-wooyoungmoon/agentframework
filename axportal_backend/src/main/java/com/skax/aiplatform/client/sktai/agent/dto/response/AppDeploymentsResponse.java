...
/**
 * SKTAI Agent App 배포 목록 응답 DTO
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Schema(description = "SKTAI Agent App 배포 목록 응답 정보")
public class AppDeploymentsResponse {
    ...
    @JsonProperty("data")
    @Schema(description = "배포 목록")
    private List<AppDeploymentInfo> data;
