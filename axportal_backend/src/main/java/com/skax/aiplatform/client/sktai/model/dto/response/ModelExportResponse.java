...
/**
 * SKTAI Model Export 응답 DTO
 * 
 * <p>SKTAI Model 시스템에서 Model Export 결과를 담는 응답 데이터 구조입니다.
 * Export용 Model 데이터를 포함하며, 중복 필드를 제외한 구조입니다.</p>
 *
 * @since 2025-11-11
 * @version 1.0
 */
...
@AllArgsConstructor
@Builder
@Schema(description = "SKTAI Model Export 응답")
public class ModelExportResponse {
    
    @JsonProperty("model")
    @Schema(description = "Export용 Model 데이터 (중복 필드 제외)")
    ...
    @AllArgsConstructor
    @Builder
    @Schema(description = "Export용 Model 데이터")
