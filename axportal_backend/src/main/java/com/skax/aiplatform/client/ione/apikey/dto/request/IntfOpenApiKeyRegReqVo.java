...
/**
 * IONE Open API Key 등록 요청 DTO
 * 
 * <p>IONE API Gateway에서 새로운 Open API Key를 등록하기 위한 요청 데이터 구조입니다.
 * 실제 IONE API Swagger 문서의 IntfOpenApiKeyRegReqVo 스키마를 기반으로 구현되었습니다.</p>
 * 
...
public class IntfOpenApiKeyRegReqVo {
