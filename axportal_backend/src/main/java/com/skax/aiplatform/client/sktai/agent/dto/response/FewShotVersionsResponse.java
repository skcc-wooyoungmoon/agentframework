...
/**
 * SKTAI Agent Few-Shot 버전 목록 응답 DTO
 * 
 * <p>특정 Few-Shot의 모든 버전 목록을 담는 응답 데이터 구조입니다.</p>
 *
 * @author gyuHeeHwang
 * @since 2025-08-15
 * @version 1.0
...
@AllArgsConstructor
@Builder
@Schema(description = "SKTAI Agent Few-Shot 버전 목록 응답")
public class FewShotVersionsResponse {
    ...
    private List<FewShotVersionDetail> data;
