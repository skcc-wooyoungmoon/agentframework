...
/**
 * SKTAI Agent Serving 수정 요청 DTO
 * 
 * <p>SKTAI Serving 시스템에서 기존 에이전트 서빙의 설정을 수정하기 위한 요청 데이터 구조입니다.
 * 에이전트 서빙의 리소스 할당, 오토스케일링 설정, 보안 필터 등을 업데이트할 수 있습니다.</p>
 * 
 * <h3>수정 가능한 항목:</h3>
 * <ul>
 ...
 * @since 2025-08-15
 * @version 1.0
 * @see AgentServingResponse 에이전트 서빙 수정 응답
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Schema(
    description = "SKTAI Agent Serving 수정 요청 정보",
    example = """
        {
          "description": "업데이트된 고객 상담용 대화형 AI 에이전트",
          "cpu_request": 3,
          "cpu_limit": 6,
          "gpu_request": 1,
          "gpu_limit": 2,
...
public class AgentServingUpdate {
     ...
     * 대화 설정, 응답 옵션, 세션 관리 등을 수정할 수 있습니다.</p>
     */
     ...
     * 입력 안전 필터 적용 여부
     * 
     * <p>사용자 입력에 대한 안전 필터링을 적용할지 여부입니다.</p>
     */
