...
/**
 * IONE Open API Key 갱신 응답 DTO
 * 
 * <p>IONE API Gateway에서 기존 Open API Key를 갱신하는 응답 데이터 구조입니다.
 * 실제 IONE API Swagger 문서의 RenewApiKeyResult 스키마를 기반으로 구현되었습니다.</p>
 * 
...
@Builder
@Schema(
    description = "IONE Open API Key 갱신 응답",
    example = """
        {
          "result": {
            "success": true,
          ...
          "data": "202501081856019122HEHDKS017641M4VU62Q4T7ZIUEHFM543",
          "success": true
        }
        """
)
public class RenewApiKeyResult {
    ...
    /**
     * 갱신된 Open API Key 문자열
     */
    @JsonProperty("data")
    @Schema(
        description = "갱신된 Open API Key 문자열",
     ...
     * 갱신된 Open API Key 조회
     * 
     * @return 갱신된 Open API Key (실패 시 null)
     */
    public String getRenewedApiKey() {
