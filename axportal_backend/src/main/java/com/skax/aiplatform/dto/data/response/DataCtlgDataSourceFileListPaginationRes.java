...
@Builder
@Schema(
    description = "데이터소스 파일 목록 페이징 정보",
    example = """
        {
          "page": 1,
          "firstPageUrl": "//datasources/454c67ff-99f6-4295-8cfb-810be4345467/files?page=1&size=10",
          "from": 1,
          "lastPage": 1,
          "links": [
            {
...
public class DataCtlgDataSourceFileListPaginationRes {
    ...
    private List<DataCtlgDataSourceFileListPaginationLinkRes> links;
