...
@AllArgsConstructor
@Builder
@Schema(description = "가드레일 프롬프트 상세 정보")
public class GuardRailPromptByIdRes {
    ...
    @JsonProperty("name")
    @Schema(description = "프롬프트 이름", example = "GuardRail Prompt")
    private String name;

    @JsonProperty("desc")
    @Schema(description = "프롬프트 설명", example = "가드레일 프롬프트 설명")
    ...
    @Builder.Default
    private List<GuardRailPromptRes.TagInfo> tags = List.of();
