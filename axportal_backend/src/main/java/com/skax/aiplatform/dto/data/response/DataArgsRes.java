...
@Builder
@Schema(
    description = "Data Tool 연결 정보"
)
public class DataArgsRes {
    
    @JsonProperty("data")
    @Schema(
        description = "Tool 타입 정의 목록",
        example = """
            [
              {
                ...
                "supportedFileExtensions": [".pdf", ".jpg", ".jpeg", ".png"],
                "enable": true
              }
            ]
            """
    )
    private List<DataArgRes> data;  // 이 부분이 문제! DataArgRes가 아니라 다른 타입이어야 함
}
