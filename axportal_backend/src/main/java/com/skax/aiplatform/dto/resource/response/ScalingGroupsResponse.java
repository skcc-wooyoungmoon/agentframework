 ...
 * 
 * <p>
 * Backend.AI 리소스 그룹별 자원 할당량 조회 결과를 담는 내부 응답 데이터 구조입니다.
 * 카멜케이스로 직렬화됩니다.
 * </p>
 * 
 * <h3>포함 정보:</h3>
...
@AllArgsConstructor
@Builder
@Schema(description = "스케일링 그룹 조회 응답 정보", example = """
        {
          "scalingGroups": [
            {
              "name": "default",
              ...
              "wsproxyAddr": "127.0.0.1:5050",
              "wsproxyApiToken": "secret-token",
              "agentTotalResourceSlotsByStatus": {
                "ALIVE": {
                  "cpu": 32,
                  "mem": "64g",
                  "cuda.device": 4
        ...
        """)
public class ScalingGroupsResponse {
    ...
    public static class ScalingGroup {
        ...
        private List<GetAgentListResponse.Agent> agentList;
    }
