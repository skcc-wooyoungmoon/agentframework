...
public class CreateImageReq {
    ...
    @Schema(description = "이미지명", example = "VSCode Python Dev", maxLength = 50)
    private String imgNm;

    @NotBlank(message = "이미지 경로는 필수입니다")
    @Schema(description = "이미지 경로 (URL)", example = "https://registry.example.com/vscode/python:1.0", maxLength = 100)
    private String imgUrl;

    @NotBlank(message = "설명은 필수입니다")
    @Schema(description = "이미지 설명", example = "Python 개발 환경 기본 구성", maxLength = 100)
