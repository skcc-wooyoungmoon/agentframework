...
import com.skax.aiplatform.dto.model.request.FineTuningEnum.modelType;
import com.skax.aiplatform.dto.model.request.FineTuningEnum.tuningType;
...
public class ModelFineTuningTrainingsRes {
    ...
    @Schema(description = "파인튜닝 모델 튜닝 타입", example = "QLoRa")
    private tuningType tuningType;

    @Schema(description = "파인튜닝 모델 타입", example = "생성")
    @JsonProperty("modelType")
    private modelType modelType;

    public String getModelType() {
        return modelType != null ? modelType.getValue() : null;
    }

    @Schema(description = "파인튜닝 모델 리스트 넘버", example = "1")
    private int no;
