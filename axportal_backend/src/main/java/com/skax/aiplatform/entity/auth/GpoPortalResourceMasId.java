...
/**
 * Composite key for GpoPortalResourceMas: (authority_id, scope, resource_url)
 */
@Embeddable
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@EqualsAndHashCode
public class GpoPortalResourceMasId implements Serializable {
    ...
    public GpoPortalResourceMasId(String authorityId, String scope, String resourceUrl) {
