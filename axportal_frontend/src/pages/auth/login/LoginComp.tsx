...
import { UIButton2, UIIcon2, UITypography } from '@/components/UI';
...
export const LoginComp = () => {
  ...
  const handleConfirm = () => {
    ...
    navigate('/home/dashboard', { replace: true, state: { firstLogin: true } });
  };
    ...
    >
      ...
      <div className='absolute z-[10] flex flex-col items-center w-full' style={{ maxWidth: '496px' }}>
        ...
        <div className='pt-[40px]'>
          <UIButton2 className='btn-primary-blue !h-[48px]' onClick={handleConfirm}>
            확인
          </UIButton2>
        </div>
      </div>
