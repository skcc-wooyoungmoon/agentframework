          ...
          <UIArticle>
            ...
            <div className='article-body'>
              <div className='chart-container'>
                {/* [251110_퍼블수정] : 그래프 - 데이터 없음처리시 series={[]}  */}
                <UILineChart label='Time To First Token' x='추론 시각' y='소요 시간' options={barChartStateSmall1.options} series={barChartStateSmall1.series} height={292} />
                <UILineChart label='Time Per Output Token' x='추론 시각' y='소요 시간' options={barChartStateSmall2.options} series={barChartStateSmall2.series} height={292} />
                <UILineChart label='모델 추론시간' x='추론 시각' y='소요 시간' options={barChartStateSmall3.options} series={barChartStateSmall3.series} height={292} />
                {/* <UIBarChart label='Time Per Output Token' x='x:시간 (ms)' y='y:요청수(개)' options={barChartStateSmall2.options} series={barChartStateSmall2.series} height={292} />
                <UIBarChart label='Time Per Output Token' x='x:시간 (ms)' y='y:요청수(개)' options={barChartStateSmall3.options} series={barChartStateSmall3.series} height={292} /> */}
              </div>
            </div>
          </UIArticle>
        </UIPageBody>
