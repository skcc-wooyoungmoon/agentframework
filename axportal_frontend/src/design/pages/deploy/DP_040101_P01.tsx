...
export const DP_040101_P01: React.FC = () => {
    ...
    <>
      ...
      >
        ...
        <section className='section-popup-content'>
          {/* 레이어 팝업 헤더 */}
          <UIPopupHeader title='세이프티 필터 수정' description='분류와 금지어를 입력해 새로운 규칙을 만들어보세요.' position='right' />
                    ...
                    <div key={index}>
                      <UIUnitGroup gap={8} direction='row' align='start'>
                        <div className='flex-1'>
                          <UIInput.Text value={word} onChange={e => handleBannedWordChange(index, e.target.value)} placeholder='금지어 입력' />
                        </div>
