                ...
                <div className='flex-1 flex ml-[60px] justify-center'>
                  <div className='flex chart-graph h-[300px] gap-x-20 justify-center'>
                    <div className='w-[240px] flex items-center justify-center'>
                      <UICircleChart.Half type='CPU' value={50} total={50} showLabel={false} /> {/* [참고] showLabel : 그래프 하단의 라벨(사용중인 자원) 숨김 처리 */}
                    </div>
                    <div className='w-[240px] flex items-center justify-center'>
            ...
            <UIArticle>
              ...
              <div className='w-full flex flex-col space-y-[8px]'>
                ...
                <UISlider
                  label='CPU'
                  value={cpuValue}
                  min={0} // [251102-퍼블수정] : min={0} 디폴트 수정필요
                  max={92}
                  required={true}
                ...
                <UISlider
                  ...
                  showTextField={true}
                  decimalPlaces={1}
                  step={0.1} // [251126_퍼블수정] : 소수점일 경우 step 값 추가 하여 0.1 단위로 증가
                />
              </div>
            </UIArticle>
