...
export const LO_020103: React.FC = () => {
  const {} = useModal();
  ...
  const datasetData = [
    ...
    },
    {
      ...
      totalTime: 'sess_002',
      description:
        ' "request_id": "req_20250812_001", "input_text": "오늘 날씨 어때?", "processing_status": "completed" "processing_log": "[{\"step_name\":\"input_received\ \"timestamp\":\"2025-08-12T10:45:32.124Z\"}, ',
      callKeyName: '김신한',
    },
    {
      id: '3',
      ...
      totalTime: 'sess_003',
      description:
        ' "request_id": "req_20250812_001", "input_text": "오늘 날씨 어때?", "processing_status": "completed", "processing_log": "[{\"step_name\":\"input_received\ \"timestamp\":\"2025-08-12T10:45:32.124Z\"},{\"step_name\":\"intent_detection\",\"result\":\"weather_query\",\"timestamp\":\"2025-08-12T10:45:32.150Z\"} ',
      callKeyName: '김신한',
    },
    {
      id: '4',
      ...
      status: '정상',
      totalTime: 'sess_004',
      description: '텍스트가 한줄일때~~텍스트가 한줄일때~~텍스트가 한줄일때~~텍스트가 한줄일때~~텍스트가 한줄일때~~',
      callKeyName: '김신한',
    },
    {
      id: '5',
      ...
      totalTime: 'sess_005',
      description:
        '텍스트 두줄입니다. 테스트 테스트 텍스트 두줄입니다. 테스트 테스트 텍스트 두줄입니다. 테스트 테스트텍스트 두줄입니다. 테스트 테스트텍스트 두줄입니다. 테스트 테스트텍스트 두줄입니다. 테스트 테스트',
      callKeyName: '김신한',
    },
    {
      id: '6',
          ...
          <UIArticle className='article-grid'>
            <UIListContainer>
              ...
              <UIListContentBox.Body>
                <UIGrid type='multi-select' rowData={currentData} columnDefs={columnDefs} domLayout={'autoHeight'} />
              </UIListContentBox.Body>
