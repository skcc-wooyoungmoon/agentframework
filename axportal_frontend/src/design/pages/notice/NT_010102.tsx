import { UIFileBox, /* UILabel, UIButton2, */ UITypography } from '../../../components/UI/atoms';
import { /* UIUnitGroup, */ UIPageHeader, UIPageBody, /* UIPageFooter, */ UIArticle, UIGroup } from '../../../components/UI/molecules';
import { DesignLayout } from '../../components/DesignLayout';

export const NT_010102 = () => {
  return (
    <DesignLayout
          ...
          <UIArticle>
            <div className='pt-[16px] pb-[56px] border-b border-[#DCE2ED]'>
              <UITypography variant='body-2' className='secondary-neutral-900 whitespace-pre-wrap'>
                ...
                해당 시간에는 자동화 작업 및 모델 배포 기능도 일시적으로 중단되며, 작업 상황에 따라 점검 종료 시간이 변경될 수 있습니다.{'\n'}
