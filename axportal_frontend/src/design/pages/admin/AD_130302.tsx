          ...
          <UIArticle className='article-grid'>
            <div className='article-body'>
              ...
              <div className='chart-container mt-4'>
                <UIBarChart label='시간별 호출건수' x='시간(시)' y='호출 건수(건)' options={barChartState.options} series={barChartState.series} height={368} />
              </div>
              <div className='chart-container flex mt-4'>
                <UILineChart label='평균 응답시간' x='시간(시)' y='시간(초)' options={lineChartState3.options} series={lineChartState3.series} />
                <UILineChart label='호출 성공률' x='시간(시)' y='성공률(%)' options={lineChartState4.options} series={lineChartState4.series} />
              </div>
            </div>
          </UIArticle>
        </UIPageBody>
