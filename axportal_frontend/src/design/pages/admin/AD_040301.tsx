                        ...
                        <td>
                          <div className='flex-1'>
                            <UIDropdown
                              ...
                              options={[
                                { value: 'val1', label: '상태1' },
                                { value: 'val2', label: '상태2' },
                                { value: 'val3', label: '상태3' },
                              ]}
                        ...
                        <td>
                          <div className='flex-1'>
                            <UIDropdown
                              ...
                              options={[
                                { value: 'val1', label: '노드 그룹명1' },
                                { value: 'val2', label: '노드 그룹명2' },
                                { value: 'val3', label: '노드 그룹명3' },
                              ]}
            ...
            <div className='article-body'>
              ...
              <div className='chart-container grid-col2 mt-4'>
                ...
                <div className='chart-item flex-1 !p-5'>
                  ...
                  <div className='chart-header flex !items-start'>
                  ...
                  <div className='grid grid-cols-2 relative -top-[20px] justify-items-center chart-graph h-[480px] justify-center items-center !bg-transparent'>
                    <UICircleChart.Half type='CPU' value={0} total={100} usedLabel='할당량' availableLabel='여유량' />
                    <UICircleChart.Half type='Memory' value={0} total={0} usedLabel='할당량' availableLabel='여유량' />
                    <UICircleChart.Half type='GPU' value={128.72} total={1007.4} usedLabel='할당량' availableLabel='여유량' />
                  </div>
                </div>
                {/* Chart 영역 구분 */}
              ...
              <div className='chart-container grid-col2 mt-4'>
                ...
                <div className='chart-item flex-1'>
                  ...
                  <div className='grid grid-cols-2 relative -top-[20px] justify-items-center chart-graph h-[480px] justify-center items-center !bg-transparent'>
                    <UICircleChart.Half type='CPU' value={50} total={98} usedLabel='할당량' availableLabel='여유량' />
                    <UICircleChart.Half type='Memory' value={20} total={100} usedLabel='할당량' availableLabel='여유량' />
                    <UICircleChart.Half type='GPU' value={128.72} total={1007.4} usedLabel='할당량' availableLabel='여유량' />
                  </div>
                </div>
