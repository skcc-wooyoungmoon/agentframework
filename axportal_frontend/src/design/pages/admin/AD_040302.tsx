...
export const AD_040302 = () => {
  ...
  const rowData = [
    {
      id: '1',
      workloadName: '02455e0b-9364-4e21-b470-445c9a091369',
      allocation: '0.500',
      actualUsage: '0.0000123',
      allocationUsageRate: '22.5%',
    },
    {
      id: '2',
      workloadName: '02455e0b-9364-4e21-b470-445c9a091369',
      ...
      <section className='section-page'>
        ...
        <UIPageBody>
          ...
          <UIArticle>
            ...
            <div className='chart-container'>
              {/* [251110_퍼블수정] : 그래프 - 데이터 없음처리시 series={[]} */}
              <UILineChart label='GPU 사용량' x='시간(초)' y='사용량' options={lineChartState3.options} series={[]} />
            </div>
          </UIArticle>
              ...
              <UIListContentBox.Header>
                <UIUnitGroup gap={16} direction='column'>
                  <div className='flex justify-between w-full items-center'>
                    <div className='flex-shrink-0'>
                      <div style={{ width: '168px', paddingRight: '8px' }}>
                        <UIDataCnt count={rowData.length} prefix='GPU Quota 총' unit='건' />
                      </div>
                    </div>
                    <div className='flex'>
                      <div style={{ width: '160px', flexShrink: 0 }}>
