...
export const AG_030101_P01: React.FC = () => {
      ...
      >
        ...
        <section className='section-popup-content'>
          ...
          <UIPopupBody>
            ...
            <UIArticle>
              <UIFormField gap={8} direction='column'>
                {/* [251117_퍼블수정] : 설명 타이틀 - required={true} 추가 */}
                <UITypography variant='title-4' className='secondary-neutral-800 text-sb' required={true}>
                  설명
                </UITypography>
            ...
            <UIArticle>
              <UIFormField gap={8} direction='column'>
                ...
                <UIUnitGroup gap={8} direction='row'>
                  ...
                  />
                  <div>
                    <UIButton2 className='btn-secondary-outline !min-w-[64px]' onClick={handleTagAdd}>
                      연결
                    </UIButton2>
                  </div>
                </UIUnitGroup>
            ...
            <UIArticle>
              <UIFormField gap={8} direction='column'>
                ...
                <UIInput.Text value={authorization} placeholder='User name 입력' onChange={e => setAuthorization(e.target.value)} />
              </UIFormField>
            </UIArticle>
