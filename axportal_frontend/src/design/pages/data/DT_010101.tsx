...
export const DT_010101 = () => {
  ...
  const [activeTab, setActiveTab] = useState('dataTab1');
                        ...
                        <td>
                          <div>
                            <UIDropdown
                              ...
                              options={[
                                { value: '전체', label: '전체' },
                                { value: 'S-basic', label: 'S-basic' },
                                { value: 'IT Helpdesk', label: 'IT Helpdesk' },
                                { value: 'SOL-SAM', label: 'SOL-SAM' },
                                { value: 'SWING', label: 'SWING' },
                                { value: '법무윤리 시스템', label: '법무윤리 시스템' },
                                { value: 'SPURT/통단', label: 'SPURT/통단' },
                                { value: '고객상담센터/챗봇', label: '고객상담센터/챗봇' },
                                { value: 'KMS', label: 'KMS' },
                                { value: '뉴스데이터', label: '뉴스데이터' },
                              ]}
