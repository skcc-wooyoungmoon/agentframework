        ...
        cellRenderer: React.memo((params: any) => {
          return (
            <div className='flex items-center gap-1'>
              <UITextLabel intent='gray'>{params.value}</UITextLabel>
            </div>
          );
        }),
      },
  ...
  const rowCardData = [
    {
      no: 1,
      id: '1',
      modelName: 'chatbot_response_flow',
      description: '설명문구는 최대 한줄까지만 노출됩니다.',
      deployType: '이용가능',
      tagName: 'chatbot_response_flow',
      permission: 'Public',
      creationDate: '2024-01-20 14:25:00',
      statusLabels: [{ text: 'Lastest.1', intent: 'gray' }],
      more: 'more',
      isActive: true,
    },
    {
        ...
        <UIPageHeader
          ...
          actions={
            <>
              ...
              <UIButton2 className='btn-text-18-semibold-point' leftIcon={{ className: 'ic-system-24-add' }}>
                워크플로우 등록
              </UIButton2>
            </>
          }
