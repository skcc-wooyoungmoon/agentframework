...
export const PR_030202_P02: React.FC = () => {
          ...
          <UIPopupBody>
            ...
            <UIArticle>
              <UIFormField gap={8} direction='column'>
                ...
                <UIInput.Text value={'금융보안'} placeholder='이름 입력' onChange={_e => {}} />
              </UIFormField>
            </UIArticle>
            ...
            <UIArticle>
              <UIFormField gap={8} direction='column'>
                ...
                <UITextArea2 value={description} placeholder='프롬프트 설명 입력' onChange={e => setDescription(e.target.value)} maxLength={4000} />
              </UIFormField>
            </UIArticle>
