import { CustomTableRow } from '@/components/agents/builder/pages/table/base/CustomTableRow.tsx';
import { NoData } from '@/components/agents/builder/pages/table/NoData.tsx';
import { type BaseRecord, type BaseTableProps, type CustomTableRowProps } from '@/components/agents/builder/types/table.ts';
...
const BaseTable = <T extends BaseRecord>({
  ...
  return (
    <div className='w-full overflow-x-auto mt-1'>
      <div className={['w-full max-w-full table-fixed', maxHeight && `max-h-[${maxHeight}px]`].filter(e => !!e).join(' ')}>
