// import { type ColorType } from "@/app/common/components/badge/types/badge.ts";
...
export type CustomHeaderColumnProps<T extends object> = {
  column: CustomColumn<T>;
  title?: string;
  sortable?: boolean;
  sortBy: { id: string; desc: boolean } | null;
  // eslint-disable-next-line no-unused-vars
  setSortBy: (sortBy: { id: string; desc: boolean } | null) => void;
  // eslint-disable-next-line no-unused-vars
  updateSortParam?: (sortType: string, sortColumn: string) => void;
